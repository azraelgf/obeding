    ...
    class Popup {
        ...
        close(selectorValue) {
            ...
            requestAnimationFrame(() => {
                const activeEl = this.previousOpen.element.querySelector(":focus");
        ...
        _openToHash() {
            ...
            if (popupElement) {
                const trigger = document.querySelector(`[data-popup="#${classInHash}"][data-popup-youtube]`);
                this.youTubeCode = trigger ? trigger.getAttribute(this.options.youtubeAttribute) : null;
        ...
        _loadYouTube() {
            const videoUrl = this.youTubeCode;
            ...
            if (youtubePlace) {
                ...
                video.src = videoUrl;
                video.controls = true;
                video.autoplay = this.options.setAutoplayYoutube || false;
                video.playsInline = true;
                video.style.maxWidth = "100%";
                video.style.height = "auto";
                youtubePlace.appendChild(video);
            }
        }
    }
    window.flsModules = window.flsModules || {};
    window.flsModules.popup = new Popup({});
